...
#running area graphs
#graphs to save
#tiff('GR_Comb_lineplotpanels_colbyenvlight.tiff', units="in", width=14, height=12, res=300, compression = 'lzw')
pdf('GR_Comb_lineplotpanels_colbyenvlight_thin.pdf', width=14, height=12)
...
for(i in 1:24){
  lines(sadf$time, sadf[, i], col = "blue", lty = 2, lwd = 1)
  lines(sadf$time, sadf[, 2], col = "blue", lty = 2, lwd = 1)
  lines(sadf$time, sadf[, 3], col = "red", lty = 1, lwd = 1)
  lines(sadf$time, sadf[, 4], col = "blue", lty = 2, lwd = 1)
  lines(sadf$time, sadf[, 5], col = "blue", lty = 2, lwd = 1)
  lines(sadf$time, sadf[, 6], col = "blue", lty = 2, lwd = 1)
  lines(sadf$time, sadf[, 7], col = "red", lty = 1, lwd = 1)
  lines(sadf$time, sadf[, 8], col = "red", lty = 1, lwd = 1)
  lines(sadf$time, sadf[, 9], col = "red", lty = 1, lwd = 1)
  lines(sadf$time, sadf[, 10], col = "blue", lty = 2, lwd = 1)
  lines(sadf$time, sadf[, 11], col = "red", lty = 1, lwd = 1)
  lines(sadf$time, sadf[, 12], col = "blue", lty = 2, lwd = 1)
  lines(sadf$time, sadf[, 13], col = "blue", lty = 2, lwd = 1)
  lines(sadf$time, sadf[, 14], col = "red", lty = 1, lwd = 1)
  lines(sadf$time, sadf[, 15], col = "red", lty = 1, lwd = 1)
  lines(sadf$time, sadf[, 16], col = "blue", lty = 2, lwd = 1)
  lines(sadf$time, sadf[, 17], col = "blue", lty = 2, lwd = 1)
  lines(sadf$time, sadf[, 18], col = "blue", lty = 2, lwd = 1)
  lines(sadf$time, sadf[, 19], col = "blue", lty = 2, lwd = 1)
  lines(sadf$time, sadf[, 20], col = "red", lty = 1, lwd = 1)
  lines(sadf$time, sadf[, 21], col = "red", lty = 1, lwd = 1)
  lines(sadf$time, sadf[, 22], col = "red", lty = 1, lwd = 1)
  lines(sadf$time, sadf[, 23], col = "blue", lty = 2, lwd = 1)
  lines(sadf$time, sadf[, 24], col = "blue", lty = 2, lwd = 1)
...
axis(2, las = 1)
#legend("bottomright", pt.cex = 150, cex = 0.3, col = "#00000033", lty = sort(line_type), lwd = 1, legend = names(sadf[-ncol(sadf)])) #include all except final column
box()
#dev.off()
...
for(i in 1:24){
  for(i in 1:24){
    lines(sadf1$time, sadf1[, i], col = "blue", lty = 2, lwd = 1)
    lines(sadf1$time, sadf1[, 2], col = "blue", lty = 2, lwd = 1)
    lines(sadf1$time, sadf1[, 3], col = "red", lty = 1, lwd = 1)
    lines(sadf1$time, sadf1[, 4], col = "blue", lty = 2, lwd = 1)
    lines(sadf1$time, sadf1[, 5], col = "blue", lty = 2, lwd = 1)
    lines(sadf1$time, sadf1[, 6], col = "blue", lty = 2, lwd = 1)
    lines(sadf1$time, sadf1[, 7], col = "red", lty = 1, lwd = 1)
    lines(sadf1$time, sadf1[, 8], col = "red", lty = 1, lwd = 1)
    lines(sadf1$time, sadf1[, 9], col = "red", lty = 1, lwd = 1)
    lines(sadf1$time, sadf1[, 10], col = "blue", lty = 2, lwd = 1)
    lines(sadf1$time, sadf1[, 11], col = "red", lty = 1, lwd = 1)
    lines(sadf1$time, sadf1[, 12], col = "blue", lty = 2, lwd = 1)
    lines(sadf1$time, sadf1[, 13], col = "blue", lty = 2, lwd = 1)
    lines(sadf1$time, sadf1[, 14], col = "red", lty = 1, lwd = 1)
    lines(sadf1$time, sadf1[, 15], col = "red", lty = 1, lwd = 1)
    lines(sadf1$time, sadf1[, 16], col = "blue", lty = 2, lwd = 1)
    lines(sadf1$time, sadf1[, 17], col = "blue", lty = 2, lwd = 1)
    lines(sadf1$time, sadf1[, 18], col = "blue", lty = 2, lwd = 1)
    lines(sadf1$time, sadf1[, 19], col = "blue", lty = 2, lwd = 1)
    lines(sadf1$time, sadf1[, 20], col = "red", lty = 1, lwd = 1)
    lines(sadf1$time, sadf1[, 21], col = "red", lty = 1, lwd = 1)
    lines(sadf1$time, sadf1[, 22], col = "red", lty = 1, lwd = 1)
    lines(sadf1$time, sadf1[, 23], col = "blue", lty = 2, lwd = 1)
    lines(sadf1$time, sadf1[, 24], col = "blue", lty = 2, lwd = 1)
  }
}
#axis(1, las = 1) hash out so doesnt add x labels as defined
...
for(i in 1:24){
    lines(sadf3$time, sadf3[, i], col = "blue", lty = 2, lwd = 1)
    lines(sadf3$time, sadf3[, 2], col = "blue", lty = 2, lwd = 1)
    lines(sadf3$time, sadf3[, 3], col = "red", lty = 1, lwd = 1)
    lines(sadf3$time, sadf3[, 4], col = "blue", lty = 2, lwd = 1)
    lines(sadf3$time, sadf3[, 5], col = "blue", lty = 2, lwd = 1)
    lines(sadf3$time, sadf3[, 6], col = "blue", lty = 2, lwd = 1)
    lines(sadf3$time, sadf3[, 7], col = "red", lty = 1, lwd = 1)
    lines(sadf3$time, sadf3[, 8], col = "red", lty = 1, lwd = 1)
    lines(sadf3$time, sadf3[, 9], col = "red", lty = 1, lwd = 1)
    lines(sadf3$time, sadf3[, 10], col = "blue", lty = 2, lwd = 1)
    lines(sadf3$time, sadf3[, 11], col = "red", lty = 1, lwd = 1)
    lines(sadf3$time, sadf3[, 12], col = "blue", lty = 2, lwd = 1)
    lines(sadf3$time, sadf3[, 13], col = "blue", lty = 2, lwd = 1)
    lines(sadf3$time, sadf3[, 14], col = "red", lty = 1, lwd = 1)
    lines(sadf3$time, sadf3[, 15], col = "red", lty = 1, lwd = 1)
    lines(sadf3$time, sadf3[, 16], col = "blue", lty = 2, lwd = 1)
    lines(sadf3$time, sadf3[, 17], col = "blue", lty = 2, lwd = 1)
    lines(sadf3$time, sadf3[, 18], col = "blue", lty = 2, lwd = 1)
    lines(sadf3$time, sadf3[, 19], col = "blue", lty = 2, lwd = 1)
    lines(sadf3$time, sadf3[, 20], col = "red", lty = 1, lwd = 1)
    lines(sadf3$time, sadf3[, 21], col = "red", lty = 1, lwd = 1)
    lines(sadf3$time, sadf3[, 22], col = "red", lty = 1, lwd = 1)
    lines(sadf3$time, sadf3[, 23], col = "blue", lty = 2, lwd = 1)
    lines(sadf3$time, sadf3[, 24], col = "blue", lty = 2, lwd = 1)
}
#axis(1, las = 1) hash out so doesnt add x labels as defined
...
rect(xleft = 14, ybottom = -50, xright = 21, ytop = 5000, col ="#00000033", border = "#FFFFFFFF")
  for(i in 1:24){
    lines(sadf4$time, sadf4[, i], col = "blue", lty = 2, lwd = 1)
    lines(sadf4$time, sadf4[, 2], col = "blue", lty = 2, lwd = 1)
    lines(sadf4$time, sadf4[, 3], col = "red", lty = 1, lwd = 1)
    lines(sadf4$time, sadf4[, 4], col = "blue", lty = 2, lwd = 1)
    lines(sadf4$time, sadf4[, 5], col = "blue", lty = 2, lwd = 1)
    lines(sadf4$time, sadf4[, 6], col = "blue", lty = 2, lwd = 1)
    lines(sadf4$time, sadf4[, 7], col = "red", lty = 1, lwd = 1)
    lines(sadf4$time, sadf4[, 8], col = "red", lty = 1, lwd = 1)
    lines(sadf4$time, sadf4[, 9], col = "red", lty = 1, lwd = 1)
    lines(sadf4$time, sadf4[, 10], col = "blue", lty = 2, lwd = 1)
    lines(sadf4$time, sadf4[, 11], col = "red", lty = 1, lwd = 1)
    lines(sadf4$time, sadf4[, 12], col = "blue", lty = 2, lwd = 1)
    lines(sadf4$time, sadf4[, 13], col = "blue", lty = 2, lwd = 1)
    lines(sadf4$time, sadf4[, 14], col = "red", lty = 1, lwd = 1)
    lines(sadf4$time, sadf4[, 15], col = "red", lty = 1, lwd = 1)
    lines(sadf4$time, sadf4[, 16], col = "blue", lty = 2, lwd = 1)
    lines(sadf4$time, sadf4[, 17], col = "blue", lty = 2, lwd = 1)
    lines(sadf4$time, sadf4[, 18], col = "blue", lty = 2, lwd = 1)
    lines(sadf4$time, sadf4[, 19], col = "blue", lty = 2, lwd = 1)
    lines(sadf4$time, sadf4[, 20], col = "red", lty = 1, lwd = 1)
    lines(sadf4$time, sadf4[, 21], col = "red", lty = 1, lwd = 1)
    lines(sadf4$time, sadf4[, 22], col = "red", lty = 1, lwd = 1)
    lines(sadf4$time, sadf4[, 23], col = "blue", lty = 2, lwd = 1)
    lines(sadf4$time, sadf4[, 24], col = "blue", lty = 2, lwd = 1)
}
#axis(1, las = 1) hash out so doesnt add x labels as defined
